defmodule Lunity.Audio.Native do
  ...
  defmodule Nif do
    ...
    @spec stream_open(sample_rate :: float(), channels :: integer(), frames_per_buffer :: integer()) ::
            {:ok, reference()} | {:error, String.t()}
    def stream_open(_sample_rate, _channels, _frames_per_buffer), do: :erlang.nif_error(:nif_not_loaded)
